...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference IteratorTasksReference = MetadataReference.CreateFromAssembly(typeof(Task).Assembly);
        private static readonly MetadataReference IteratorTasksExtensionsReference = MetadataReference.CreateFromAssembly(typeof(TaskEx).Assembly);
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            var solution = new AdhocWorkspace()
                ...
                .AddMetadataReference(projectId, IteratorTasksReference)
                .AddMetadataReference(projectId, IteratorTasksExtensionsReference);
